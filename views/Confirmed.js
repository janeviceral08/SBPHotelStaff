...
export function Confirmed({ navigation, route }) {
...
{ cancelable: false }
  ...
  const Details = (project) => {
          ...
          navigation.navigate("ConfirmedItem", {
  ...
  return (
    <View>
     ...
     >
        ...
        <Text style={{marginTop: 20, fontWeight: 'bold', color: 'white'}}>Confirmed Reservation</Text>
