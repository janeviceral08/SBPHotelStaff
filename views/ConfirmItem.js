...
import { Dimensions, StyleSheet, ScrollView, Image, TouchableOpacity, Button, PermissionsAndroid,Alert, BackHandler, TextInput, Modal } from 'react-native';
...
export function ConfirmItem({ navigation, route }) {
...
const CancelButton =()=>{
 ...
 CancelRes(checkinInfo, Reason);  BackPage();
...
const ConfirmButton =()=>{
  ...
  Alert.alert(
    ...
    [
      ...
      { text: "OK", onPress: () =>   {Toast.show('Please Wait');ConfirmRes(checkinInfo);  BackPage()
}         
}
],
{ cancelable: false }
        ...
        <View> 
                    <Card style={{flex: 0, marginTop: 10, width: '90%', marginLeft: '5%'}} >
                      ...
                      />    
                                            ...
                                            <Right>
                                            <Button title={'Confirm'} onPress={ConfirmButton}  color={Colors.buttons}/>
                                            </Right>
