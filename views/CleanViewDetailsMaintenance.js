...
export function CleanViewDetailsMaintenance({ actions, visible, closeOverlay, roomInfo }) {
  const { Room_checklist_maintain, tasks } = useTasks();
            ...
            onPress={() => {
                Alert.alert(
                    ...
                    [
                      ...
                      { text: "OK", onPress: () => Room_checklist_maintain(roomInfo, newRoomNumber,selectedItems )
                }
                ],
                { cancelable: false }
