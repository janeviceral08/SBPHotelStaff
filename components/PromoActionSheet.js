...
if( check_in == "" && Customer == "" && Address == "" || Contact == ""  || Nationality == "" || NoPerson == "" ||  RoomID == "" ){
  ...
  PromoCheckin(newRoomType,newRoomPrice,newMaxPerson,id,RoomID,RoomFloor,RoomName,check_in,check_out,Company,Customer,Address,Contact,Nationality,Email,NoPerson,ExtraPerson,PersonWDiscount,Discount,DiscountID,Note,newExtraPerson,control_num, roomTypeInfo,RoomTypeIds,RoomIDTemp,"","Over The Counter","",
  0,
  "",
  0,);
